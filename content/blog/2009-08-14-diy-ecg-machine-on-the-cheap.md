...
I think this is the same one I used in the 3rd video from my single op-amp circuit. \[[scottecg.snd](https://swharden.com/blog/images/scottecg.snd)\] It's about an hour long, and in raw sound format (1000 Hz). It's already been filtered (low-pass filtered at 30Hz). You can use it with my code below!

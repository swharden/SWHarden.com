...
**Update (2026-04-26):** I received an email that provided additional information regarding PSG010 pin names and tips for zeroing:

> I suggest that the original design intent for the pin names on the diagram of the sensor could be:
> * `4` - GND
> * `2` & `5` - bridge arms 
> * `1` & `6` - bridge excitation via a balance potentiometer (e.g., 100 ohm) with ends connected to `1` & `6` and the wiper to `VCC`
> 
> This would allow the bridge to be zeroed.
> 
> -- <cite class="text-end">Peter</cite>
